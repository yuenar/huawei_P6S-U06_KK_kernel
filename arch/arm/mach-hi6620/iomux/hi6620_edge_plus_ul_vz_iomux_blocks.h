...
static struct  iomux_pin *flash_pins_edge_plus_ul_vz[] = {
    &ISP_GPIO5_EDGE_PLUS_UL_VZ, &RF_GPIO_20_EDGE_PLUS_UL_VZ,  NULL,
};
...
static struct  iomux_pin *bt_pins_edge_plus_ul_vz[] = {
    &UART4_CTS_N_EDGE_PLUS_UL_VZ, &UART4_RTS_N_EDGE_PLUS_UL_VZ, &UART4_RXD_EDGE_PLUS_UL_VZ, &UART4_TXD_EDGE_PLUS_UL_VZ,  &GPIO_15_7_EDGE_PLUS_UL_VZ,  NULL,
};
...
static enum lowlayer_func bt_func_normal_edge_plus_ul_vz[] = {FUNC0, FUNC0, FUNC0, FUNC0, FUNC0,  -INVALID,};
static enum pull_updown bt_pullud_normal_edge_plus_ul_vz[] = {NOPULL, NOPULL, NOPULL, NOPULL, NOPULL,  -INVALID,};
static enum drive_strength bt_drv_normal_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0,  -INVALID,};

static enum lowlayer_func bt_func_lowpower_edge_plus_ul_vz[] = {FUNC0, FUNC4, FUNC0, FUNC4, FUNC0,  -INVALID,};
static enum pull_updown bt_pullud_lowpower_edge_plus_ul_vz[] = {NOPULL, PULLUP, NOPULL, PULLUP, NOPULL,  -INVALID,};
static enum drive_strength bt_drv_lowpower_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0,  -INVALID,};
...
static enum lowlayer_func codec_func_normal_edge_plus_ul_vz[] = {FUNC0, FUNC0, FUNC0, FUNC0,  -INVALID,};
static enum pull_updown codec_pullud_normal_edge_plus_ul_vz[] = {NOPULL, NOPULL, NOPULL, NOPULL,  -INVALID,};
static enum drive_strength codec_drv_normal_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0, LEVEL0,  -INVALID,};

static enum lowlayer_func codec_func_lowpower_edge_plus_ul_vz[] = {FUNC0, FUNC0, FUNC0, FUNC0,  -INVALID,};
static enum pull_updown codec_pullud_lowpower_edge_plus_ul_vz[] = {NOPULL, NOPULL, NOPULL, NOPULL,  -INVALID,};
static enum drive_strength codec_drv_lowpower_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0, LEVEL0,  -INVALID,};
...
static struct  iomux_pin *rf_pins_edge_plus_ul_vz[] = {
    &RF_TX_EN1_EDGE_PLUS_UL_VZ, &RF_TCVR_ON0_EDGE_PLUS_UL_VZ, &RF_TCVR_ON1_EDGE_PLUS_UL_VZ, &RF_SSI0_EDGE_PLUS_UL_VZ, &RF_SSI1_EDGE_PLUS_UL_VZ, &RF_GPIO_2_EDGE_PLUS_UL_VZ, &RF_GPIO_3_EDGE_PLUS_UL_VZ, &RF_GPIO_4_EDGE_PLUS_UL_VZ, &RF_GPIO_5_EDGE_PLUS_UL_VZ, &RF_GPIO_13_EDGE_PLUS_UL_VZ, &RF_GPIO_14_EDGE_PLUS_UL_VZ, &RF_GPIO_15_EDGE_PLUS_UL_VZ, &RF_GPIO_16_EDGE_PLUS_UL_VZ, &RF_GPIO_17_EDGE_PLUS_UL_VZ, &RF_GPIO_18_EDGE_PLUS_UL_VZ, &RF_GPIO_22_EDGE_PLUS_UL_VZ, &RF_GPIO_23_EDGE_PLUS_UL_VZ, &RF_GPIO_26_EDGE_PLUS_UL_VZ, &RF_GPIO_28_EDGE_PLUS_UL_VZ,  NULL,
};
...
static enum lowlayer_func rf_func_normal_edge_plus_ul_vz[] = {FUNC4, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0,  -INVALID,};
static enum pull_updown rf_pullud_normal_edge_plus_ul_vz[] = {NOPULL, NOPULL, NOPULL, PULLDOWN, PULLDOWN, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL,  -INVALID,};
static enum drive_strength rf_drv_normal_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0,  -INVALID,};

static enum lowlayer_func rf_func_lowpower_edge_plus_ul_vz[] = {FUNC4, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0,  -INVALID,};
static enum pull_updown rf_pullud_lowpower_edge_plus_ul_vz[] = {NOPULL, NOPULL, NOPULL, PULLDOWN, PULLDOWN, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL,  -INVALID,};
static enum drive_strength rf_drv_lowpower_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0,  -INVALID,};
...
/*exphp pins */
static struct  iomux_pin *exphp_pins_edge_plus_ul_vz[] = {
    &GPIO_5_1_EDGE_PLUS_UL_VZ,  NULL,
};

/*define blocks: exphp*/
IOMUX_BLOCK(block_exphp_edge_plus_ul_vz, "block_exphp", NORMAL, exphp_pins_edge_plus_ul_vz)



/*EXPHP*/

static enum lowlayer_func exphp_func_normal_edge_plus_ul_vz[] = {FUNC0,  -INVALID,};
static enum pull_updown exphp_pullud_normal_edge_plus_ul_vz[] = {NOPULL,  -INVALID,};
static enum drive_strength exphp_drv_normal_edge_plus_ul_vz[] = {LEVEL0,  -INVALID,};

static enum lowlayer_func exphp_func_lowpower_edge_plus_ul_vz[] = {FUNC0,  -INVALID,};
static enum pull_updown exphp_pullud_lowpower_edge_plus_ul_vz[] = {NOPULL,  -INVALID,};
static enum drive_strength exphp_drv_lowpower_edge_plus_ul_vz[] = {LEVEL0,  -INVALID,};

static struct block_config exphp_config_edge_plus_ul_vz[] = {
    [NORMAL] = {exphp_func_normal_edge_plus_ul_vz, exphp_pullud_normal_edge_plus_ul_vz, exphp_drv_normal_edge_plus_ul_vz},
    [LOWPOWER] = {exphp_func_lowpower_edge_plus_ul_vz, exphp_pullud_lowpower_edge_plus_ul_vz, exphp_drv_lowpower_edge_plus_ul_vz},
...
/*usim1 pins */
static struct  iomux_pin *usim1_pins_edge_plus_ul_vz[] = {
    &USIM1_CLK_EDGE_PLUS_UL_VZ, &USIM1_DATA_EDGE_PLUS_UL_VZ, &USIM1_RST_EDGE_PLUS_UL_VZ,  NULL,
};

/*define blocks: usim1*/
IOMUX_BLOCK(block_usim1_edge_plus_ul_vz, "block_usim1", NORMAL, usim1_pins_edge_plus_ul_vz)



/*USIM1*/

static enum lowlayer_func usim1_func_normal_edge_plus_ul_vz[] = {FUNC0, FUNC0, FUNC0,  -INVALID,};
static enum pull_updown usim1_pullud_normal_edge_plus_ul_vz[] = {NOPULL, NOPULL, NOPULL,  -INVALID,};
static enum drive_strength usim1_drv_normal_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0,  -INVALID,};

static enum lowlayer_func usim1_func_lowpower_edge_plus_ul_vz[] = {FUNC0, FUNC0, FUNC0,  -INVALID,};
static enum pull_updown usim1_pullud_lowpower_edge_plus_ul_vz[] = {NOPULL, NOPULL, NOPULL,  -INVALID,};
static enum drive_strength usim1_drv_lowpower_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0,  -INVALID,};

static struct block_config usim1_config_edge_plus_ul_vz[] = {
    [NORMAL] = {usim1_func_normal_edge_plus_ul_vz, usim1_pullud_normal_edge_plus_ul_vz, usim1_drv_normal_edge_plus_ul_vz},
    [LOWPOWER] = {usim1_func_lowpower_edge_plus_ul_vz, usim1_pullud_lowpower_edge_plus_ul_vz, usim1_drv_lowpower_edge_plus_ul_vz},
...
static struct  iomux_pin *gps_pins_edge_plus_ul_vz[] = {
    &RF_GPIO_1_EDGE_PLUS_UL_VZ, &UART3_CTS_N_EDGE_PLUS_UL_VZ, &UART3_RTS_N_EDGE_PLUS_UL_VZ, &UART3_RXD_EDGE_PLUS_UL_VZ, &UART3_TXD_EDGE_PLUS_UL_VZ, &GPS_CLK_EDGE_PLUS_UL_VZ,  NULL,
};
...
static enum lowlayer_func gps_func_normal_edge_plus_ul_vz[] = {FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0,  -INVALID,};
static enum pull_updown gps_pullud_normal_edge_plus_ul_vz[] = {NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL,  -INVALID,};
static enum drive_strength gps_drv_normal_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0,  -INVALID,};

static enum lowlayer_func gps_func_lowpower_edge_plus_ul_vz[] = {FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC2,  -INVALID,};
static enum pull_updown gps_pullud_lowpower_edge_plus_ul_vz[] = {NOPULL, NOPULL, NOPULL, NOPULL, NOPULL, NOPULL,  -INVALID,};
static enum drive_strength gps_drv_lowpower_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0,  -INVALID,};
...
static struct  iomux_pin *tcxo_pins_edge_plus_ul_vz[] = {
    &TCXO0_AFC_EDGE_PLUS_UL_VZ, &TCXO1_AFC_EDGE_PLUS_UL_VZ,  NULL,
};
...
static enum lowlayer_func tcxo_func_normal_edge_plus_ul_vz[] = {FUNC0, FUNC0,  -INVALID,};
static enum pull_updown tcxo_pullud_normal_edge_plus_ul_vz[] = {NOPULL, NOPULL,  -INVALID,};
static enum drive_strength tcxo_drv_normal_edge_plus_ul_vz[] = {LEVEL0, LEVEL0,  -INVALID,};

static enum lowlayer_func tcxo_func_lowpower_edge_plus_ul_vz[] = {FUNC4, FUNC4,  -INVALID,};
static enum pull_updown tcxo_pullud_lowpower_edge_plus_ul_vz[] = {PULLDOWN, PULLDOWN,  -INVALID,};
static enum drive_strength tcxo_drv_lowpower_edge_plus_ul_vz[] = {LEVEL0, LEVEL0,  -INVALID,};
...
static struct  iomux_pin *wifi_pins_edge_plus_ul_vz[] = {
    &SDIO_DATA3_EDGE_PLUS_UL_VZ, &SDIO_DATA2_EDGE_PLUS_UL_VZ, &SDIO_DATA1_EDGE_PLUS_UL_VZ, &SDIO_DATA0_EDGE_PLUS_UL_VZ, &SDIO_CMD_EDGE_PLUS_UL_VZ, &SDIO_CLK_EDGE_PLUS_UL_VZ,  NULL,
};
...
static enum lowlayer_func wifi_func_normal_edge_plus_ul_vz[] = {FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0,  -INVALID,};
static enum pull_updown wifi_pullud_normal_edge_plus_ul_vz[] = {PULLUP, PULLUP, PULLUP, PULLUP, PULLUP, NOPULL,  -INVALID,};
static enum drive_strength wifi_drv_normal_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0,  -INVALID,};

static enum lowlayer_func wifi_func_lowpower_edge_plus_ul_vz[] = {FUNC2, FUNC2, FUNC2, FUNC2, FUNC2, FUNC2,  -INVALID,};
static enum pull_updown wifi_pullud_lowpower_edge_plus_ul_vz[] = {PULLUP, PULLUP, PULLUP, PULLUP, PULLUP, NOPULL,  -INVALID,};
static enum drive_strength wifi_drv_lowpower_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0,  -INVALID,};
...
static struct  iomux_pin *boot_pins_edge_plus_ul_vz[] = {
    &BOOT_SEL_EDGE_PLUS_UL_VZ, &GPIO_5_2_EDGE_PLUS_UL_VZ,  NULL,
};
...
static enum lowlayer_func boot_func_normal_edge_plus_ul_vz[] = {FUNC0, FUNC0,  -INVALID,};
static enum pull_updown boot_pullud_normal_edge_plus_ul_vz[] = {PULLUP, PULLDOWN,  -INVALID,};
static enum drive_strength boot_drv_normal_edge_plus_ul_vz[] = {LEVEL0, LEVEL0,  -INVALID,};

static enum lowlayer_func boot_func_lowpower_edge_plus_ul_vz[] = {FUNC0, FUNC0,  -INVALID,};
static enum pull_updown boot_pullud_lowpower_edge_plus_ul_vz[] = {PULLUP, PULLDOWN,  -INVALID,};
static enum drive_strength boot_drv_lowpower_edge_plus_ul_vz[] = {LEVEL0, LEVEL0,  -INVALID,};
...
/*es305 pins */
static struct  iomux_pin *es305_pins_edge_plus_ul_vz[] = {
    &I2S_XCLK_EDGE_PLUS_UL_VZ, &I2S_XFS_EDGE_PLUS_UL_VZ, &I2S_DI_EDGE_PLUS_UL_VZ, &I2S_DO_EDGE_PLUS_UL_VZ, &PCM0_XCLK_EDGE_PLUS_UL_VZ, &PCM0_XFS_EDGE_PLUS_UL_VZ, &PCM0_DI_EDGE_PLUS_UL_VZ, &PCM0_DO_EDGE_PLUS_UL_VZ, &UART1_TXD_EDGE_PLUS_UL_VZ, &UART2_RXD_EDGE_PLUS_UL_VZ, &UART2_TXD_EDGE_PLUS_UL_VZ, &TS_ERR_EDGE_PLUS_UL_VZ,  NULL,
};

/*define blocks: es305*/
IOMUX_BLOCK(block_es305_edge_plus_ul_vz, "block_es305", NORMAL, es305_pins_edge_plus_ul_vz)



/*ES305*/

static enum lowlayer_func es305_func_normal_edge_plus_ul_vz[] = {FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC2, FUNC4, FUNC4, FUNC1,  -INVALID,};
static enum pull_updown es305_pullud_normal_edge_plus_ul_vz[] = {NOPULL, NOPULL, PULLDOWN, NOPULL, NOPULL, NOPULL, PULLDOWN, NOPULL, PULLDOWN, PULLDOWN, PULLDOWN, PULLDOWN,  -INVALID,};
static enum drive_strength es305_drv_normal_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0,  -INVALID,};

static enum lowlayer_func es305_func_lowpower_edge_plus_ul_vz[] = {FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC0, FUNC2, FUNC4, FUNC4, FUNC1,  -INVALID,};
static enum pull_updown es305_pullud_lowpower_edge_plus_ul_vz[] = {NOPULL, NOPULL, PULLDOWN, NOPULL, NOPULL, NOPULL, PULLDOWN, NOPULL, PULLDOWN, PULLDOWN, PULLDOWN, PULLDOWN,  -INVALID,};
static enum drive_strength es305_drv_lowpower_edge_plus_ul_vz[] = {LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0, LEVEL0,  -INVALID,};

static struct block_config es305_config_edge_plus_ul_vz[] = {
    [NORMAL] = {es305_func_normal_edge_plus_ul_vz, es305_pullud_normal_edge_plus_ul_vz, es305_drv_normal_edge_plus_ul_vz},
    [LOWPOWER] = {es305_func_lowpower_edge_plus_ul_vz, es305_pullud_lowpower_edge_plus_ul_vz, es305_drv_lowpower_edge_plus_ul_vz},
...
struct iomux_block_table block_config_table_edge_plus_ul_vz[] = {
    ...
    BLOCK_CONFIG("block_exphp", &block_exphp_edge_plus_ul_vz, exphp_config_edge_plus_ul_vz)
    ...
    BLOCK_CONFIG("block_usim1", &block_usim1_edge_plus_ul_vz, usim1_config_edge_plus_ul_vz)
    ...
    BLOCK_CONFIG("block_es305", &block_es305_edge_plus_ul_vz, es305_config_edge_plus_ul_vz)
