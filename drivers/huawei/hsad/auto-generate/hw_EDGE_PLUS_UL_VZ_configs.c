...
config_pair  hw_EDGE_PLUS_UL_VZ_configs [] = {
    ...
    {"audio/comph_val", (unsigned int)130, E_CONFIG_DATA_TYPE_INT },
    ...
    {"camera/miniisp", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    ...
    {"camera/primary_sensor_raw_h", (unsigned int)2464, E_CONFIG_DATA_TYPE_INT },
    {"camera/primary_sensor_raw_w", (unsigned int)3280, E_CONFIG_DATA_TYPE_INT },
    {"camera/primary_sensor_zsl", (unsigned int)1, E_CONFIG_DATA_TYPE_INT },
    ...
    {"camera/secondary_sensor_raw_h", (unsigned int)1952, E_CONFIG_DATA_TYPE_INT },
    {"camera/secondary_sensor_raw_w", (unsigned int)2592, E_CONFIG_DATA_TYPE_INT },
    ...
    {"sd_card/sdcard_support", (unsigned int)0, E_CONFIG_DATA_TYPE_INT },
    ...
    {"synaptics/x_res", (unsigned int)720, E_CONFIG_DATA_TYPE_INT },
    {"synaptics/y_res", (unsigned int)1280, E_CONFIG_DATA_TYPE_INT },
